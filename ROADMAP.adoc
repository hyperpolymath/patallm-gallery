...
* ** bindings**: Generated via wasm-bindgen or FFI
...
* **Language**: Rust +  (API layer)
* **Runtime**:  for HTTP client and async I/O
...
* **Language**: Rust (core) +  (orchestration)
...
* -based server (Hono or Oak framework)
