...
Replace all {{PLACEHOLDER}} values with your information:
  Patallm Gallery     - Your project name
  hyperpolymath            - GitHub username or org (e.g., hyperpolymath)
  patallm-gallery             - Repository name
...
1. Navigate to [Report a Vulnerability](https://github.com/hyperpolymath/patallm-gallery/security/advisories/new)
...
- This repository (`hyperpolymath/patallm-gallery`) and all its code
...
- **GitHub Security Advisories**: Published at [Security Advisories](https://github.com/hyperpolymath/patallm-gallery/security/advisories)
...
When using Patallm Gallery, we recommend:
...
- [Security Advisories](https://github.com/hyperpolymath/patallm-gallery/security/advisories)
...
| Purpose | Contact |
|---------|---------|
| **Security issues** | [Report via GitHub](https://github.com/hyperpolymath/patallm-gallery/security/advisories/new) or 6759885+hyperpolymath@users.noreply.github.com |
| **General questions** | [GitHub Discussions](https://github.com/hyperpolymath/patallm-gallery/discussions) |
...
*Thank you for helping keep Patallm Gallery and its users safe.* 🛡️
