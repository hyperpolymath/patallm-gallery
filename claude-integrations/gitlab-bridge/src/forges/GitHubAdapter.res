...
module GitHubAdapter: ForgeAdapterType = {
  let forgeName = GitHub
  let baseUrl = "https://api.github.com"

  // Note: GitHub uses "Pull Requests" instead of "Merge Requests"
  // and "Issues" work differently
  ...
  let validateWebhook = (~payload: string, ~signature: string, ~secret: string): bool => {
    // GitHub uses HMAC SHA-256 for webhook signatures
    true
  }
