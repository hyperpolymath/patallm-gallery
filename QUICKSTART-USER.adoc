...
// Replace patallm-gallery, Patallm Gallery — See README.adoc for details., just run, Patallm Gallery started successfully. with actuals
= patallm-gallery — Quick Start for Users
:toc:
:toclevels: 2

== What is patallm-gallery?

Patallm Gallery — See README.adoc for details.
...
[source,bash]
----
just install --portable --prefix=./patallm-gallery-portable
----
...
[source]
----
Patallm Gallery started successfully.
----
...
* **Wiki**: https://github.com/hyperpolymath/patallm-gallery/wiki
