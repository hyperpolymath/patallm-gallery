...
= Contributing — patallm-gallery
:revdate: 2026-MM-DD

== Audience

Developers working *on* `patallm-gallery`. For consumers (people calling
...
[source,bash]
----
git clone git@github.com:hyperpolymath/patallm-gallery.git
cd patallm-gallery
...
* Bugs in `patallm-gallery`: file at `hyperpolymath/patallm-gallery/issues`.
