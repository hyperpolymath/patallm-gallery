...
**This repository is not finished being set up.** 15 substitution token(s) across 17 file(s) still have no value.
...
- `did-you-actually-do-that/Justfile`
- `llm-tools/unify/Justfile`
- `llm-tools/verify/Justfile`
...
- `claude-integrations/CODE_OF_CONDUCT.md`
- `claude-integrations/firefox-mcp/CODE_OF_CONDUCT.md`
- `claude-integrations/mozilla-extension/CODE_OF_CONDUCT.md`
- `llm-tools/CODE_OF_CONDUCT.md`
...
- `claude-integrations/firefox-mcp/SECURITY.md`
- `claude-integrations/mozilla-extension/SECURITY.md`
...
- `Justfile`
- `claude-integrations/gecko-browser-extension/Justfile`
- `esn/Justfile`
- `llm-tools/unify-core/Justfile`
- `llm-tools/unify/Justfile`
